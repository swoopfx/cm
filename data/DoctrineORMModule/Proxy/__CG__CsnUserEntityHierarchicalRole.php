 ...
 */
class HierarchicalRole extends \CsnUser\Entity\HierarchicalRole implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'children', 'permissions'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HierarchicalRole $proxy) {
