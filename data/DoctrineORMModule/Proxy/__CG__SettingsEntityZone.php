 ...
 */
class Zone extends \Settings\Entity\Zone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Settings\\Entity\\Zone' . "\0" . 'id', '' . "\0" . 'Settings\\Entity\\Zone' . "\0" . 'zoneName', '' . "\0" . 'Settings\\Entity\\Zone' . "\0" . 'code', '' . "\0" . 'Settings\\Entity\\Zone' . "\0" . 'status', '' . "\0" . 'Settings\\Entity\\Zone' . "\0" . 'country'];
        }
