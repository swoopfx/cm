 ...
 */
class CustomerAdministrator extends \Customer\Entity\CustomerAdministrator implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Customer\\Entity\\CustomerAdministrator' . "\0" . 'id', '' . "\0" . 'Customer\\Entity\\CustomerAdministrator' . "\0" . 'administrator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomerAdministrator $proxy) {
